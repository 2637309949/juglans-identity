...
module.exports = function ({
  ...
  identityTokenRoute({ router, route, findToken })
  revokeTokenRoute({ router, route, revokeToken })
  refleshTokenRoute({router, route, findToken, revokeToken, saveToken, expiresIn})
  authTokenRoute({router, authToken, fakeTokens, fakeUrls, findToken})
}
